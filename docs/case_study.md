...
Latest engineering verification: Ruff passed and 133 tests passed. API container and
...
1. Run the explicit trusted-LAN physical-device mode, then complete the private-by-default
   `docs/human_accessibility_media_review.md` pack with a human screen-reader/real-device review
   and record a public-safe narrated walkthrough.
