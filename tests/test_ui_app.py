...
def _app() -> AppTest:
    return AppTest.from_file(APP_PATH, default_timeout=5).run()
...
def test_sample_match_and_extraction_journeys_render_contract_evidence(ui_api: dict[str, Any]) -> None:
    ...
    assert metrics == {"Match score": "67.5/100", "Verdict": "Potential match", "Skill gaps": "2"}
    ...
    assert extraction_metrics == {"Experience": "0.0", "Seniority": "Entry", "Work mode": "Hybrid"}
